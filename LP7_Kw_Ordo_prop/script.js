(function () {
  ...
  var t = {
    ar: {
      ...
      t2: "● بدون أي التزامات، يمكنك إلغاء اشتراكك في أي وقت عن طريق إرسال UNSUB 5 إلى 50908",
    ...
    en: {
      topInfo: "Free for 24 hours! Then the service will be charged at 800 fils per week including VAT.",
      ...
      tcAgree: "By clicking the Subscribe button above, you agree to the following terms and conditions",
      t1: "● The paid subscription will start automatically after the free trial period.",
      t2: "● With no obligation, you can cancel your subscription at any time by sending UNSUB 5 to 50908",
    ...
    mForm.addEventListener("submit", function (e) {
      ...
      getUserIp(function (ip) {
        ...
        callApi("sendpin", params)
          .then(function (resp) {
            var sk = (resp && (resp.sessionKey || resp.ti || resp.TI)) || "";

<?php
/**
 * Proxy for Zeen adnet APIs (UAE Etisalat foodie cid=3186).
 * GET zeen-api.php?path=sendpin&cid=3186&msisdn=971...&click_id=...
 */
...
if (function_exists('curl_init')) {
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_USERAGENT => 'ZeenLP-UAE-Foodie/1.0',
    ]);
    $body = curl_exec($ch);

 ...
 *
 * Example:
 *   propeller-pb.php?visitor_id=REAL_SUBID&payout=3.56
 */
...
$payout = isset($_GET['payout']) ? trim($_GET['payout']) : '3.56';

if ($visitorId === '' || $visitorId === '${SUBID}' || strtolower($visitorId) === 'clickid' || stripos($visitorId, 'local_') === 0) {

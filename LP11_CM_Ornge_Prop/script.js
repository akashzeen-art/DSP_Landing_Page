(function () {
  ...
  /**
   * Cameroon Orange — OneGaming (cid=496) CMcmp — PropellerAds
  ...
  var t = {
    en: {
      ...
      privacyLink: "Privacy",
      disclaimer:
        "Orange: 100 CFA per day. This service renews automatically.",
      errmsg: {
    ...
    fr: {
      ...
      step1: "ÉTAPE 1/2",
      step2: "ÉTAPE 2/2",
      heroTitle: "Votre téléchargement est prêt !",
      ...
      disclaimer:
        "Orange : 100 FCFA / jour. Ce service se renouvelle automatiquement.",
      errmsg: {

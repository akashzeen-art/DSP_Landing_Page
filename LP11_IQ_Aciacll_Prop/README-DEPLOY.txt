...
Campaign URL
------------
https://click2funbox.com/LP11_IQ_Aciacll_Prop/?clickid=${SUBID}&zoneid={zone_id}
...
Upload to:
  /var/www/vaszeen/zeen_lp/oman/LP11_IQ_Aciacll_Prop/

Live:
  https://click2funbox.com/LP11_IQ_Aciacll_Prop/?clickid=${SUBID}&zoneid={zone_id}

1. Create folder oman/LP11_IQ_Aciacll_Prop/
2. Upload ALL files from this folder (including assets/)
3. Test PHP: https://click2funbox.com/LP11_IQ_Aciacll_Prop/php-test.php
4. Test LP:  https://click2funbox.com/LP11_IQ_Aciacll_Prop/?clickid=TEST123

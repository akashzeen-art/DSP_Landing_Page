(function () {
  ...
  /**
   * Côte d'Ivoire Orange — 11Barre (cid=503) CIVOrgcmp
   * 150 CFA/day — PIN 4 — Short code/Unsub: NA
   * Host: http://159.89.163.174/prod/CIVOrgcmp/
   * PropellerAds: visitor_id=${SUBID} payout=150
   * UI: LP10_CM_Ornge_Prop Theme-496
   * No antifraud
   */

  /* Doc sample: 225xxxxxxxx → 8 local digits (keep leading 0) */
  var msisdnFormat = /^[0-9]{8}$/;
  var COUNTRY = "225";
  var PIN_LENGTH = 4;
  var CID = "503";
  var PAYOUT = "150";
  var API_HOST = "159.89.163.174";
  var API_BASE = "http://" + API_HOST + "/prod/CIVOrgcmp";
  ...
  var t = {
    en: {
      ...
      disclaimer:
        "11Barre is a subscription service that auto-renews at 150 CFA every 1 day for Orange Côte d'Ivoire subscribers.",
      errmsg: {
        m: "Please enter your mobile number",
        o: "Please enter a valid Côte d'Ivoire mobile number (8 digits).",
    ...
    fr: {
      ...
      disclaimer:
        "11Barre est un service d’abonnement renouvelé automatiquement à 150 FCFA / jour pour les abonnés Orange Côte d'Ivoire.",
      errmsg: {
        m: "Veuillez entrer votre numéro mobile",
        o: "Veuillez entrer un numéro ivoirien valide (8 chiffres).",

(function () {
  ...
  /**
   * UAE Etisalat — Gamespro (cid=3102) portal 901
   * Unsub: C GWG → 1111 — PIN 4
   * PropellerAds: visitor_id=${SUBID} payout=1
  ...
  var t = {
    ar: {
      ...
      disclaimer:
        "Gamespro خدمة اشتراك لمشتركي اتصالات الإمارات. للإلغاء أرسل C GWG إلى 1111.",
      errmsg: {
    ...
    en: {
      ...
      disclaimer:
        "Gamespro is a subscription service for Etisalat UAE subscribers. To cancel, send C GWG to 1111.",
      errmsg: {

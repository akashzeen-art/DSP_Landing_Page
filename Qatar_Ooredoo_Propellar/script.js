(function () {
  ...
  /**
   * Qatar Ooredoo — ZD Games for All (Zeen Digital) + PropellerAds
   * UI: movstreamlite
   *
   * Campaign:
   ...
   * Portal: /Promo/Api/CPportal?cid=341
   * Unsub: GA → 92506
   * Propeller visitor_id = same clickid (${SUBID})
   */

  var msisdnFormat = /^[3567][0-9]{7}$/;
  var COUNTRY = "974";
  var CID = "3044";
  var PIN_LENGTH = 4;
  var ZEEN = "http://64.225.85.48/adnet";
  var PORTAL = ZEEN + "/Promo/Api/CPportal?cid=341";
  ...
  function initTracking() {
    ...
    var payout = params.get("payout") || params.get("PAYOUT") || "";
    if (payout && payout !== "${PAYOUT}") persist("payout", payout);
  }
  ...
  function getVisitorId() {
    var existing = track("click_id");
    if (!existing || existing === "${SUBID}" || String(existing).toLowerCase() === "clickid") return "";
    if (String(existing).indexOf("local_") === 0) return "";
    return existing;
  }
  ...
  function firePropellerPostback(done) {
    ...
    var payout = track("payout") || POSTBACK.payout;
    var qs =
  ...
  var t = {
    en: {
      ...
      mExample: "(example: +974 3XXX XXXX)",
      mBtn: "Subscribe",
      ...
      footerNote:
        "ZD Games for All — Ooredoo Qatar. Subscription renews automatically until you unsubscribe. To cancel, send SMS GA to 92506.",
      copyright: "&copy;&nbsp;2026&nbsp;&nbsp;All Rights Reserved",
      errmsg: {
        m: "Please enter your mobile number",
        o: "Please enter a valid Qatar mobile number (8 digits starting with 3, 5, 6 or 7).",
    ...
    ar: {
      ...
      footerNote:
        "ZD Games for All — أوريدو قطر. يتجدد الاشتراك تلقائياً حتى الإلغاء. للإلغاء أرسل GA إلى 92506.",
      copyright: "<span class=\"rtl\">2026&nbsp;&copy;&nbsp;جميع الحقوق محفوظة</span>",
      errmsg: {
        m: "الرجاء إدخال رقم الجوال",
        o: "يرجى إدخال رقم قطري صحيح (8 أرقام يبدأ بـ 3 أو 5 أو 6 أو 7).",

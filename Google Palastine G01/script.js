(function () {
  ...
  /**
   * Gamers Paradise — Palestine G01 (Adpoke) — Google Ads
   *
   * Campaign: https://castmax-fun.com/psgog01?clickid={gclid}
   *
   * Ooredoo PS: adid=232, cmpid=469, NIS 1.5/day, unsub NS → 7902
   * Jawwal PS:  adid=232, cmpid=468, NIS 1.16/day, unsub SP → 37637
   *
   * sendotp / validateotp (param1=PIN) / statuscheck / portal
   * Base: http://64.225.87.221/adpoke/cnt/inapp
   * Success: { "response": "SUCCESS", ... }
   * Google: AW-18322570229 (same tags as Google Palastine)
   */
  ...
  // Backup PHP proxy (same Adpoke upstream; used if same-folder PHP fails)
  var REMOTE_ADPOKE_PROXY = "https://castmax-fun.com/adpoke-api.php";
  ...
  function proxyCandidates() {
    ...
    // castmax /psgog01: prefer same-folder PHP, then domain root proxy
    return [sameFolderProxyHref(), REMOTE_ADPOKE_PROXY];
  }

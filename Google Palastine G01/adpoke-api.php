<?php
/**
 * Google Palestine G01 — Adpoke API proxy (REQUIRED on production HTTPS).
 * Upload next to index.html in /psgog01/
 *
 * G01: adid=232 | Ooredoo cmpid=469 | Jawwal cmpid=468
 * Endpoints: sendotp / validateotp / statuscheck / portal
 * Upstream: http://64.225.87.221/adpoke/cnt/inapp/{path}
 */

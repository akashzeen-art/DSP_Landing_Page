(function () {
   ...
   * UI: LP10_IQ_Aciacll_Clkdu Theme-496
   *
   * Orange OneGaming — cid=502 — 159.89.163.174 CMcmp — 100 CFA/day — PIN 4
  ...
  var t = {
    en: {
      ...
      disclaimer:
        "OneGaming is a subscription service for Orange Cameroon at 100 CFA per day. Short code and unsubscribe keyword are not available for this offer.",
      errmsg: {
        m: "Please enter your mobile number",
        o: "Please enter a valid Orange Cameroon number (9 digits starting with 6).",
    ...
    fr: {
      heroTitle: "Plus qu'une étape pour jouer",
      formTitle: "Entrez votre numéro de téléphone",
      continueBtn: "Continuer",
      confirmBtn: "Confirmer",
      pinTitle: "Entrez le code PIN",
      pinHint: "Un code PIN à 4 chiffres a été envoyé sur votre téléphone.",
      wrongNumber: "Mauvais numéro ?",
      termsLink: "Conditions générales",
      privacyLink: "Politique de confidentialité",
      disclaimer:
        "OneGaming est un service d'abonnement Orange Cameroun à 100 CFA par jour. Le short code et le mot-clé de désabonnement ne sont pas disponibles pour cette offre.",
      errmsg: {
        m: "Veuillez entrer votre numéro de mobile",
        o: "Veuillez entrer un numéro Orange Cameroun valide (9 chiffres commençant par 6).",
        p: "Veuillez entrer le code PIN à 4 chiffres",
      ...
      getUserIp(function (ip) {
        ...
        callApi("sendPIN", params)
          .then(function (resp) {
            ...
            if (resp.sessionKey) persist("sessionKey", resp.sessionKey);
            showPinStep();

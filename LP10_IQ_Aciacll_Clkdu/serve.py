#!/usr/bin/env python3
"""
Iraq Asiacell Gamifya Clickadu LP local server.
  python3 serve.py
...
def main() -> None:
    ...
    print("Iraq Asiacell Gamifya Clickadu LP: http://%s:%s/" % (HOST, PORT))
    print("Proxies: /iq-api.php  /asiacell-af.php  /clickadu-pb.php")
    try:

(function () {
  ...
  var t = {
    ar: {
      ...
      disclaimer:
        "ZD Gamez خدمة اشتراك لمشتركي عمانتل. مجانًا لمدة 24 ساعة ثم 0.25 ريال عماني يومياً شاملاً الضريبة. للإلغاء أرسل UNSUB IVID إلى 92149.",
      errmsg: {
    ...
    en: {
      ...
      disclaimer:
        "ZD Gamez is a subscription service for Omantel. Free for 24 hours, then OMR 0.25/day including VAT. To cancel, send UNSUB IVID to 92149.",
      errmsg: {
